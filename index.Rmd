...
The findCorrelation() function in the caret package was used to remove variables that are highly correlated with other variables. In the end, 46 variables including classe were retained. The 406 observations were split into a training set (307 observations) and a testing set (99 observations). A random-forest algorithm with 25-fold cross-validation was trained on the training set and used to predict the classe variable in the testing set.
